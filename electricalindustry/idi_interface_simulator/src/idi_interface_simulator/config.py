...
class ConfigStore(AppConfigBasic):
    ...
    data = {
        'app_group': '乐清工业云',
        'app_name': 'idi_interface_simulator',
        'switch': True,
                ...
                'idi_config': {
                    ...
                    'group_member': {
                        ...
                        'idi_url': {
                            ...
                            'value': 'http://192.168.20.187:8081/api/v1/idi/history/datas'
                        },
                        'idi_lastest_url': {
                            'key_name': '历史数据N条查询接口',
                            'key_type': 'string',
                            'key_help': '访问历史数据接口code_list:[{code,start_time,end_time}...]',
                            'value': 'http://192.168.20.187:8081/api/v1/idi/lastest/history/tags'
                        },
                        'idi_server_wsurl': {
                            'key_name': 'interface_server_url',
                            'key_type': 'string',
                            'key_help': 'idi_server_ws',
                            'value': 'ws://192.168.20.187:8180/interfaceappconn'
                        },
                        ...
                        'idi_write_url': {
                            ...
                            'value': 'http://192.168.20.187:8180/api/v1/idi/insert/datas'
                        },
                    }
                }
            }
