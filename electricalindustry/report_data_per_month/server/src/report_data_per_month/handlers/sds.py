...
from report_data_per_month.handlers.utils import log_exception
            ...
            if group_node:
                ...
                if group_instance_list:
                    for group_instance in group_instance_list:
                        ...
                        group_config[product_line_code][group_code] = dict()
                        group_config[product_line_code][group_code]['name'] = group_instance['name']
