                ...
                'idi_config': {
                    ...
                    'group_member': {
                        'onwork_attendance_url': {
                            ...
                            'value': 'http://192.168.20.181:12020/api/attendance_manage/pipeline/{}/onwork_attendance'
                        },
                        'idi_url': {
                        ...
                        'dispatched_plan_url': {
                            ...
                            'value': 'http://192.168.20.181:9001/api/plan_management/manage/%s/dispatched_plan/list'
                        },
                        'update_plan_url': {
                            'key_name': 'update_plan_url',
                            'key_type': 'string',
                            'key_help': 'update_plan_url',
                            'value': 'http://192.168.20.181:9001/api/plan_management/plan/status_update'
                        },
                    }
                }
            }
